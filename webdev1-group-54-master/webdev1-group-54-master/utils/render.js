 ...
 *
 * @param {string} filePath filepath as a string
 * @param {http.ServerResponse} response the returned response
 * @returns {void} 
 */
 ...
 *
 * @param {http.ServerResponse} response the response to be returned
 * @returns {void}
 */
 ...
 *
 * @param {string} fileExtension str checked
